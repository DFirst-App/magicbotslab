...
function mintCode() {
  ...
  return `MBL-${out.slice(0, 4)}-${out.slice(4)}`;
}
...
module.exports = {
  ...
  pendingRequests, waitingPeople, requestForKey, approvedCodeFor, approvedMatch, markAnswered, approveRequest, declineRequest,
