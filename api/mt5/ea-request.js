...
module.exports = async (req, res) => {
  ...
  const request = [
    ...
    id
      ...
      : "⚠️ This one could NOT be recorded, so /approve has nothing to issue a code against — the mbl_ea_requests table is missing. Apply the migration, then ask them to send the form again.",
  ].join("\n");
