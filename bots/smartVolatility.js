(() => {
  class SmartVolatilityBot {
    constructor(ui, options) {
      ...
      // When using OTP-authenticated WebSocket URLs, Deriv may not expect an `authorize` message.
    ...
    connectWebSocket() {
      ...
      this.ws.onopen = () => {
        ...
        if (this.otpAuthenticated) {
          // OTP WS is already authenticated; just subscribe and wait for ticks to drive the strategy.
          this.ui.showStatus('Connected. Waiting for volatility signal...', 'success');
